namespace Domain
{
    public class NavigationJSI : IAsyncDisposable
    {
        ...
        public NavigationJSI(IJSRuntime jsRuntime) => this.moduleTask = new(() => jsRuntime.InvokeAsync<IJSObjectReference>("import", "./_content/MAK.LibBlazorUI/js/NavigationJSI.js").AsTask());
